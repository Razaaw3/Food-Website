...
function FoodCard({ size }: Props) {
  return (
    <div className="p-8 bg-[#f5f4f4] w-60 flex flex-col gap-2 drop-shadow-2xl rounded-2xl relative">
      ...
      <h4 className="font-medium text-lg w-32">Shrimp and Mango Salad</h4>
      {size !== "sm" && <p className="text-xs">280g | 400 kcal | GF</p>}

      <p className="text-xs">
        A classic salad made with crisp ramaine lettuce, croutons and grated
        parmesan cheese, tossed in a classic Caesar dressing.
      </p>
      {size === "sm" ? (
