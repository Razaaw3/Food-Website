...
function CartPage({}: Props) {
    ...
    const Proceed = () =>{
      dispatch({type:'cart',payload:{cartItems,totalPrice:totalPrice+10}})
      router.push('/cart/checkout')
    //   const queryParams = `?cartItems=${encodeURIComponent(JSON.stringify(cartItems))}&totalPrice=${(totalPrice + 10).toFixed(2)}`;
    //   window.location.href = '/cart/checkout' + queryParams;
    } 
